...
public class Objetos {
    ...
    public static void intArraysObj(){
        ...
        /*2*/gerenteQualidade = new Obj(id++, "Gerente de Qualidade", NIVEL_F, 500, 4.0);
        /*3*/gerenteComercial = new Obj(id++, "Gerente Comercial", NIVEL_F, 3000, 10.0);
        /*4*/gerenteConfiguracao = new Obj(id++, "Gerente de Configuração", NIVEL_F, 10000, 40.0);
        /*5*/gerenteRH = new Obj(id++, "Gerente de Recursos Humanos", NIVEL_E, 40000, 100.0);
        /*6*/gerenteProducao = new Obj(id++, "Gerente de Produção", NIVEL_E,200000, 400.0);

        //inicializador das atualizações
        /*0*/posGerenciaRequisitos = new Obj(id++,"Pós-Graduação em Gerencia de Requisitos", NIVEL_G);
        /*1*/posMedicao = new Obj(id++, "Pós-Graduação em Medição", NIVEL_F);
        /*2*/MBAProjetos = new Obj(id++, "MBA em Gerenciamento de Projetos",NIVEL_F);
        /*3*/posGerenciaReutilizacao = new Obj(id++, "Pós-Graduação em Gerencia de Reutilização", NIVEL_E);
        /*4*/posGerenciaProcessos = new Obj(id++, "Pós-Graduação em Gerencia de Processos", NIVEL_E);
    }
